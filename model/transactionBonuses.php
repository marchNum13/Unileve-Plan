<?php
class recruitingBonuses extends conn{
    
    // SET ATTRIBUTE TABLE NAME
    private $table_name = "transaction_bonus";
    ...
    public function delete(){
        // query
        $sql = "DELETE FROM $this->table_name ORDER BY lvl DESC LIMIT 1";
        // EXECUTE THE QUERY
        $exe = $this->dbConn()->query($sql);
        // CLOSE THE CONNECTION
        $this->dbConn()->close();
