                ...
                <div class="card-body p-4 p-sm-5">
                  ...
                  <form class="form-body">
                    <div class="row g-3">
                      <!-- reff -->
                      <div class="col-12 ">
                        <label for="inputReff" class="form-label">Referral (Opsional)</label>
                        <div class="ms-auto position-relative">
                          <div class="position-absolute top-50 translate-middle-y search-icon px-3"><i
                              class="bi bi-person-circle"></i></div>
                          <input type="email" class="form-control radius-30 ps-5" id="inputReff"
                      ...
                      <div class="col-12">
                        <div class="d-grid">
                          <button id="btnSubmit" type="submit" name="submit" class="btn btn-primary radius-30">Sign Up</button>
                      ...
                      <!-- link login -->
                      <div class="col-12">
                        <p class="mb-0">Sudah punya akun? <a href="signin">Sign In disini!</a>
                        </p>
                      </div>
                    </div>
                  </form>
